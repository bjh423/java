...
<body onload="connect();">
	<br>
	<br>
	<img src=resources/img/chat1.png width=100 height=100>
	<img src=resources/img/chat3.png width=400 height=100>
	<div class="alert alert-danger" style="width: 500px;">
		<div>챗 봇>> 1)혼술/혼밥 2)공동구매</div>
			...
			<table>
				<tr>
					<td><input type="text" class="form-control" id="text"
						style="width: 400px; background: yellow"></td>
